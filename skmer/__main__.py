...
def subsample(args):
    ...
    for b in range (0, args.b):
        ...
        result_mat.to_csv(final_path, sep='\t', mode='w')
...
def correction(args):
    ...
    no_strap_mat.to_csv(os.path.splitext(args.main)[0] + "_cor_" +  ".txt", sep='\t', mode='w')
    ...
    new_df_out.to_csv(os.path.join(args.sub, "_summary" + ".csv"), sep=',', mode='w')
    ...
    for b in b_list:
        ...
        result_mat_main.to_csv(os.path.join(args.sub, "rep" + str(b),  "dimtrx_rep_cor.txt"), sep='\t', mode='w')
        ...
        result_mat_cons.to_csv(os.path.join(args.sub, "rep" + str(b),  "dimtrx_rep_cor_cons.txt"), sep='\t', mode='w')
